...
export const games: Game[] = [
  ...
  },
  {
    ...
    title: 'Der Koloss',
    developer: 'Vesper',
    developerSlug: 'vesper',
    developerX: null,
    genre: 'Shooter',
    status: 'Playable',
    cover: 'PLACEHOLDER_COVER',
    tagline: 'Four-player co-op zombie survival with voice chat and wonder weapons.',
    description: 'Co-op zombie survival with Pack-a-Punch, wonder weapons, and relentless waves. Up to 4 players with built-in voice chat.',
    playUrl: 'https://www.derkoloss.com/',
    aiTools: 'Claude Code (Gauntlet Loop)',
  ...
  },
  {
    slug: 'workmelt',
    title: 'Workmelt',
    developer: 'Erik Nomitch',
    developerSlug: 'erik-nomitch',
    developerX: null,
    genre: 'Shooter',
    status: 'Playable',
    cover: 'PLACEHOLDER_COVER',
    tagline: 'Quick tactical matches against your co-workers. Lobbies and room-based multiplayer.',
    description: 'A multiplayer FPS designed for office rivalries. Create a lobby, share the link, and fight your colleagues.',
    playUrl: 'https://workmelt.com/',
    aiTools: 'Claude Code (Gauntlet Loop)',
    source: 'SomethingBig.ai',
